...
def hider(element):
    element.configure(width = 0, height = 0)

def shower(element, w, h):
...
btn1L4F1 = Button(F1, cursor='hand2', text='Create Col', command=lambda:shower(F4, 200, 250), state=STATE)
btn1L4F1.place(x=100, y=140, width=125)
btn2L4F1 = Button(F1, cursor='hand2', bg=SUCCESSCOLOR, state=STATE, text='Hide', command=lambda:hider(F4))
...
F4.place(x=213, y=240, width=0, height=0)
